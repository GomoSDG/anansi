...
(defn create-texture-map []
  (p/let [hidden (.load Assets "/assets/app/img/unknown_2_128x128.png")
          question (.load Assets "/assets/app/img/question_2_128x128.png")
          empty (.load Assets "/assets/app/img/empty_128x128.png")
          eight (.load Assets "/assets/app/img/8_128x128.png")
          seven (.load Assets "/assets/app/img/7_128x128.png")
          six (.load Assets "/assets/app/img/6_128x128.png")
          five (.load Assets "/assets/app/img/5_128x128.png")
          four (.load Assets "/assets/app/img/4_128x128.png")
          three (.load Assets "/assets/app/img/3_128x128.png")
          two (.load Assets "/assets/app/img/2_128x128.png")
          one   (.load Assets "/assets/app/img/1_128x128.png")
          zero (.load Assets "/assets/app/img/empty_128x128.png")]
    {:hidden hidden
     :empty empty
     :question question
     1 one
